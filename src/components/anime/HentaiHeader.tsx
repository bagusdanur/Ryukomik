...
export default function HentaiHeader() {
    ...
    <>
          ...
          >
            ...
            <div className="leading-none">
              <span
                ...
                style={{ fontFamily: "'Syne', sans-serif" }}
              >
                Hentai<span className="text-[#ff5078]">.</span>
              </span>
              {active && (
      ...
      >
        ...
        <nav className="flex flex-col gap-1 p-4 flex-1">
            ...
            return (
              <Link
                ...
                className={`flex items-center gap-3 px-4 py-3 rounded-xl active:scale-95 ${
                  isActive
                    ? "bg-[#ff5078]/15 border border-[#ff5078]/30"
                    : "hover:bg-white/5 border border-transparent"
                }`}
              >
                <div
                  className="w-1.5 h-1.5 rounded-full flex-shrink-0"
                  style={{ background: isActive ? "#ff5078" : "rgba(255,255,255,0.15)" }}
                />
                <span
                  className={`text-[13px] font-bold ${isActive ? "text-[#ffb3c6]" : "text-white/50"}`}
                  style={{ fontFamily: "'Syne', sans-serif" }}
                >
                  {item.label}
                </span>
                {isActive && (
                  <span className="ml-auto text-[9px] font-bold text-[#ff5078]/60 tracking-widest uppercase">
                    Aktif
                  </span>
                )}
              </Link>
          ...
          >
            <div className="w-1.5 h-1.5 rounded-full flex-shrink-0" style={{ background: "#ff9f1c" }} />
            <span
